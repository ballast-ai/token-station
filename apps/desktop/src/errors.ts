...
const APP_ERROR_GUIDANCE: LocalizedAppError[] = [
  {
    ...
    en: "The first Cursor connection needs macOS Keychain access. Enter your Mac login password in the system dialog, choose Allow Once, then try again.",
    zh: "首次接入需要 macOS 钥匙串授权。请在系统对话框中输入本机登录密码，并选择“允许一次”后重试。",
  },
  {
