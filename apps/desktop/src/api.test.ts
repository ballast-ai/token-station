...
describe("desktop API mapping and read-only HTTP data plane", () => {
  ...
  it.each([
    ...
    ["discover model limits", () => discoverProviderModelLimits("p", "https://p/v1"), "discover_provider_model_limits", { name: "p", baseUrl: "https://p/v1" }],
    ["verify enterprise route", () => verifyEnterpriseRoute("https://p/v1", "k"), "verify_enterprise_route", { baseUrl: "https://p/v1", apiKey: "k" }],
    ...
    ["verify model vision", () => verifyProviderModelVision("p", "m"), "verify_provider_model_vision", { name: "p", model: "m" }],
    ...
    ["set Harness model route", () => setAgentHarnessModelRoute("claude-code", "claude-fable-5-1", "p", "m"), "set_agent_harness_model_route", { agentId: "claude-code", requestedModel: "claude-fable-5-1", upstream: "p", model: "m" }],
    ["restart Harness model routes", () => restartAgentHarnessRoutes("claude-code"), "restart_agent_harness_routes", { agentId: "claude-code" }],
