...
pub const RELEASES_URL: &str = "https://github.com/GlimpseEngine/token-station/releases";
pub const LATEST_JSON_URL: &str =
    "https://github.com/GlimpseEngine/token-station/releases/latest/download/latest.json";
