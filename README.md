...
[![Release](https://img.shields.io/github/v/release/GlimpseEngine/token-station?display_name=tag&sort=semver)](https://github.com/GlimpseEngine/token-station/releases/latest) [![CI](https://github.com/GlimpseEngine/token-station/actions/workflows/ci.yml/badge.svg)](https://github.com/GlimpseEngine/token-station/actions/workflows/ci.yml) [![Release type](https://img.shields.io/badge/v1.1.3-test%20DMG-orange.svg)](https://github.com/GlimpseEngine/token-station/releases/latest) [![License](https://img.shields.io/github/license/GlimpseEngine/token-station)](LICENSE)
