...
[下载](https://github.com/GlimpseEngine/token-station/releases/latest) · [文档](docs/README.md) · [提交问题](https://github.com/GlimpseEngine/token-station/issues) · [English](README.md)
</div>
...
请从 **[GitHub Releases](https://github.com/GlimpseEngine/token-station/releases/latest)** 下载当前版本。
...
需要 Rust 1.95 或更新版本、Node.js 22.23.1、npm，以及 Rust 的 `wasm32-wasip2` Target。Tauri 的平台依赖见[开发环境文档](docs/contributing/开发环境.md)。
